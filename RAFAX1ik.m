function theta = RAFAX1ik(Hd, theta)
close all;
...
theta_0 = theta;
figure;
plotRAFAX1KinematicModels (theta_0, 'Initial guess Pose');
...
do
  ...
  [H,J] = RAFAX1KinematicModels ( theta );
...
He,
plotRAFAX1KinematicModels (theta, 'Final pose');
