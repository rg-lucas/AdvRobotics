function plotCameraImage(Homography, IntrinsicMatrix, FocalLength, ImagePointsSensorSpace)
  % PlotCameraImage - Visualize camera image in 2D sensor space.
